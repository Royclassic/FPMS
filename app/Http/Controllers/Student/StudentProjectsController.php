...
class StudentProjectsController extends StudentBaseController
{
    ...
    {
        return view('student.projects.index', $this->data);
    }
    ...
    public function show($id)
    {
        ...
        if($this->project->checkProjectClient())
        {
            ...
            return view('student.projects.show', $this->data);
        }
        else{
    ...
    public function data()
    {
        ...
        return Datatables::of($projects)
            ->addColumn('action', function($row){
                return '<a href="'.route('student.projects.show', [$row->id]).'" class="btn btn-success btn-circle"
            ...
            ->editColumn('project_name', function($row){
                return '<a href="'.route('student.projects.show', $row->id).'">'.ucfirst($row->project_name).'</a>';
            })
