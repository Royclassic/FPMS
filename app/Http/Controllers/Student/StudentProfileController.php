...
class StudentProfileController extends StudentBaseController
{
    ...
    public function password(){
        return view('student.dashboard.password', $this->data);
    }
    ...
    public function updatePassword(){
        ...
        return view('student.dashboard.updatepassword', $this->data);
    }
    public function profile(){
        $user=Auth::user();
//        dd($user);
        return view('student.dashboard.profile', $this->data, compact('user'));
    }
