 ...
 */
class SupervisorStickyNoteController extends SupervisorBaseController
{
    ...
    public function index()
    {
        ...
        if(request()->ajax())
        {
            return   view('supervisor.sticky-note.note-ajax', $this->data);

        }

        return view('superviosr.sticky-note.index', $this->data);
    }
    ...
    public function create()
    {
        $this->noteDetail = [];
         ...
         return view('supervisor.sticky-note.create-edit', $this->data);
    }
