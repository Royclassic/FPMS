                                ...
                                <div class="pm-body clearfix">
                                    <div class="pmb-block ">
                                        ...
                                        <div class="pmbb-body p-l-30">
                                            ...
                                            <form method="POST" action="{{route('supervisor.updateBasic')}}">
                                                {{csrf_field()}}
                                                <div class="pmbb-edit">
                                                    <dl class="dl-horizontal">
                                    ...
                                    <div class="pmb-block">
                                        ...
                                        <div class="pmbb-body p-l-30">
                                            ...
                                            <form method="POST" action="{{route('supervisor.updateContact')}}">
                                                {{csrf_field()}}
                                                <div class="pmbb-edit">
                                                    <dl class="dl-horizontal">
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                ...
                                <!-- content goes here -->
                                <form id="updateform" method="POST" action="{{route('supervisor.updatephoto')}}" enctype="multipart/form-data">
                                    {{csrf_field()}}
...
@push('footer-script')
    ...
    <script src="{{ asset('plugins/bower_components/html5-editor/bootstrap-wysihtml5.js') }}"></script>
    <script src="{{URL::to('plugins/bower_components/Waves/dist/waves.min.js')}}"></script>
    <script src="{{URL::to('summernote/dist/summernote.js')}}"></script>
    <script src="{{URL::to('plugins/bower_components/malihu-custom-scrollbar-plugin/jquery.mCustomScrollbar.concat.min.js')}}"></script>
    <script src="{{URL::to('plugins/editor.js')}}"></script>
    <script src="{{URL::to('js/profile.min.js')}}"></script>
    <script src="{{asset('plugins/bower_components/eonasdan-bootstrap-datetimepicker/build/js/bootstrap-datetimepicker.min.js')}}"></script>
