                        ...
                        @foreach($students as $key=>$student)
                            @if($student->documentation!==null)
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{route('supervisor.documentation.view', $student->documentation->id)}}">
                                            <button  type="button"  class="btn btn-success btn-xs " ><span class="icon-eye" ></span> chapters</button>
                                        </a>
                                    </td>
                                </tr>
                            @endif
