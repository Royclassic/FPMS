...
@section('content')
  ...
  <div class="row">
      <div class="col-md-12 col-lg-12 col-sm-12" >
          <div class="white-box">
              <div class="card">
                  <form class="form-horizontal" role="form" action="{{route('student.logs.save')}}" method="POST" enctype="multipart/form-data">
                      {{csrf_field()}}
                      ...
                      <div class="card-body card-padding">
                          <div class="list-group lg-odd-black">
                              <div class="action-header clearfix">
                                  <div class="ah-label hidden-xs">Progress Logs for {{$student->user->name}}</div>
                                  ...
                                  <!-- <ul class="actions">
                                      <li class="dropdown">
                                          <a href="{{route('supervisor.logs.print', $student->id)}}" style="color: darkgreen; font-size: 24px">
                                      ...
                                      <div class="pull-right">
                                          <div class="actions dropdown">
                                              ...
                                              <ul class="dropdown-menu dropdown-menu-right">
                                                  <li>
                                                      <a href="#" onclick="return moretask('{{$log->id}}')">More Task</a>
                                                  </li>
                                                  <li>
                                                      <a href="{{route('supervisor.log.approve', $log->id)}}" >Approve</a>
                                                  </li>
                                                  <li>
                                                      <a href="#" onclick="return milestoneAssess('{{$log->id}}')">Assess</a>
                                                  </li>
                                              </ul>
                                          </div>
                                      </div>
                                              ...
                                              <div class="list-group-item media" style="background-color: inherit!important;">
                                                  ...
                                                  <div class="pull-right">
                                                      <div class="actions dropdown">
                                                          ...
                                                          <ul class="dropdown-menu dropdown-menu-right">
                                                              <li>
                                                                  <a href="#" onclick="return editAssessment('{{$log->id}}')">Edit</a>
                                                              </li>
                                                              <li>
                                                                  <a href="#" onclick="return assessmentDelete('{{Auth::user()->id}}')">Delete</a>

                                                              </li>
                                                          </ul>
                                                      </div>
                                                      <form method="POST" action="{{route('supervisor.log.comments.delete')}}" id="{{Auth::user()->id}}" style="display: none">
                                                          {{csrf_field()}}
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <!-- content goes here -->
                    <form action="{{route('supervisor.log.additionaltask.save')}}" method="POST">
                        {{csrf_field()}}
    ...
    <div class="modal fade" id="assessMilestone" tabindex="-1" role="dialog" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <!-- content goes here -->
                    <form action="{{route('supervisor.log.comments.save')}}" method="POST">
                        {{csrf_field()}}
                        <input type="hidden" name="milestone_id">
                        <div class="form-group">
    ...
    <div class="modal fade" id="editComment" tabindex="-1" role="dialog" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <!-- content goes here -->
                    <form action="{{route('supervisor.log.comments.update')}}" method="POST">
                        {{csrf_field()}}
                        <input type="hidden" name="milestone_id">
                        <div class="form-group">
                            <label for="password" class="col-sm-12 control-label" style="text-align: left;"><b>Comment</b></label>
...
@push('footer-script')
    ...
    <script type="text/javascript">
        ...
        function editAssessment(id) {
            var submiturl = "{{URL::to('supervisor/project/milestone/assessment/edit')}}";
            $.ajax({
                url: submiturl + '/' + id,
                type: 'GET',
                data: '',
