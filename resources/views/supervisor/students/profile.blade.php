    ...
    <div class="row bg-title">
        ...
        <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
            <ol class="breadcrumb">
                ...
                <li><a href="{{ route('student.proposal.title') }}">Student Profile</a></li>
            </ol>
        </div>
        <!-- /.breadcrumb -->
    </div>
...
@section('content')
    ...
    <div class="container container-alt ">
        ...
        <div class="block-header">
            <h2>{{$student->name}}
                <small> {{$student->admission_staff_no}} </small>
            </h2>
        </div>
                ...
                <div class="pmo-pic" >
                    <div class="p-relative"  >
                        <a href="#">
                            ...
                            @else
                                <img id="pic" class="img-responsive" src="{{URL::to('/profile/'. $student->image)}}" alt="">
                            @endif
                        </a>
