                    ...
                    <div class="col-lg-3 col-sm-6 row-in-br">
                        <div class="col-in row">
                            ...
                            <ul class="list-inline two-part">
                                ...
                                <li class="text-right"><span class="counter">{{ $counts->totalStudents }}</span></li>
                            </ul>
                        </div>
                    </div>
                    <div class="col-lg-3 col-sm-6 row-in-br  b-r-none">
                        <div class="col-in row">
                            ...
                            <ul class="list-inline two-part">
                                ...
                                <li class="text-right"><span class="counter">{{ $counts->totalLecturers }}</span></li>
                            </ul>
                        </div>
                    </div>
                    <div class="col-lg-3 col-sm-6  row-in-br">
                    ...
                    <div class="col-md-3 col-sm-12 row-in-br">
                        <div class="col-in row">
                            ...
                            <ul class="list-inline two-part">
                                ...
                                <li class="text-right"><span class="counter">{{ $counts->totalLogs}}</span></li>
                            </ul>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-md-4 col-sm-12  row-in-br  b-r-none">
                        <div class="col-in row">
                            ...
                            <ul class="list-inline two-part">
                                ...
                                <li class="text-right"><span class="counter">{{ $counts->totalDocumentations }}</span></li>
                            </ul>
                        </div>
                    </div>
                    ...
                    <div class="col-md-3 col-sm-12 row-in-br ">
                        <div class="col-in row">
                            ...
                            <ul class="list-inline two-part">
                                ...
                                <li class="text-right"><span class="counter">{{ $counts->totalNotices }}</span></li>
                            </ul>
                        </div>
                    </div>
