...
@section('page-title')
    <div class="row bg-title">
        ...
        <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
            <h4 class="page-title"><i class="{{ $pageIcon }}"></i> Proposals Reports</h4>
        </div>
        <!-- /.page title -->
        <!-- .breadcrumb -->
        <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
            <ol class="breadcrumb">
                ...
                <li class="active">Proposals Reports</li>
            </ol>
        </div>
        <!-- /.breadcrumb -->
    </div>
    ...
    <div class="white-box">
        <div class="row m-b-10">
            ...
            <div class="col-md-4">
                ...
                <form method="POST" action="{{route('admin.reports.proposals.generate')}}">
                    {{csrf_field()}}
