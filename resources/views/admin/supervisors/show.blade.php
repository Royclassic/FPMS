    ...
    <div class="row bg-title">
        ...
        <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
            <ol class="breadcrumb">
                ...
                <li><a href="{{ route('supervisors') }}">{{ $pageTitle }}</a></li>
...
<div class="row">
    <div class="col-md-4 col-xs-12">
        <div class="white-box">
            <div class="user-bg">
                {!!  ($employee->image) ? '<img src="'.asset('storage/avatar/'.$employee->image).'"
                ...
                <div class="tab-pane" id="profile">
                    <div class="row">
                        ...
                        <div class="col-xs-6"> <strong>@lang('app.mobile')</strong> <br>
                            <p class="text-muted">{{ $employee->phone or 'NA'}}</p>
                        </div>
                    </div>
                    <hr>
                    <div class="row">
...
<script>
    ...
    function showTable2(){
        ...
        var url = '{{ route('supervisors', [$employee->id]) }}';
