...
@section('page-title')
    <div class="row bg-title">
        ...
        <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
            <h4 class="page-title"><i class="{{ $pageIcon }}"></i>Supervisor</h4>
        </div>
        <!-- /.page title -->
        <!-- .breadcrumb -->
                ...
                <div class="row">
                    <div class="col-sm-6">
                        <div class="form-group">
                            <a href="{{ route('admin.supervisors.create') }}" class="btn btn-outline btn-success btn-sm">Add New Supervisor <i class="fa fa-plus" aria-hidden="true"></i></a>
                        </div>
                    </div>
                </div>
...
<script>
    $(function() {
        var table = $('#users-table').dataTable({
            ...
            processing: true,
            serverSide: true,
            ajax: '{!! route('admin.supervisors.data') !!}',
            language: {
        ...
        $('body').on('click', '.sa-params', function(){
            ...
            swal({
                ...
                if (isConfirm) {
                    ...
                    var url = "{{ route('admin.supervisors.destroy',':id') }}";
