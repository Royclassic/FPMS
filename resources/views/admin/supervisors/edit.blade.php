    ...
    <div class="row bg-title">
        ...
        <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
            <ol class="breadcrumb">
                ...
                <li><a href="{{ route('admin.students.index') }}">{{ $pageTitle }}</a></li>
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="panel panel-inverse">
                <div class="panel-heading"> Update Supervisor Info</div>
                <div class="panel-wrapper collapse in" aria-expanded="true">
                    <div class="panel-body">
                        {!! Form::open(['id'=>'updateEmployee','class'=>'ajax-form','method'=>'PUT']) !!}
                        <div class="form-body">
                            <h3 class="box-title m-t-40">Supervisor</h3>
                            <hr>
                            <div class="row">
                                <div class="col-md-6 ">
                                    <div class="form-group">
                                        <label>Supervisor Name</label>
                                        <input type="text" name="name" id="name" value="{{ $userDetail->name }}" class="form-control">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="admission_staff_no" id="admission_staff_no"  value="{{ $userDetail->admission_staff_no }}" class="form-control">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label>Phone</label>
                                        <input type="text" name="phone" id="phone" value="{{$userDetail->phone}}" class="form-control input-mask"  data-mask="+254700000000" value="+2547">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="faculty" id="faculty_value" required>
                                            ...
                                            @foreach($faculties as $faculty)
                                                <option @if($userDetail->faculty_id==$faculty->id) selected @endif value="{{$faculty->id}}">{{$faculty->faculty}}</option>
                                            @endforeach
                                        </select>
                        ...
                        <div class="form-actions">
                            ...
                            <a href="{{ route('admin.supervisors.index') }}" class="btn btn-default">@lang('app.back')</a>
                        </div>
                        {!! Form::close() !!}
                    </div>
                </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <!-- content goes here -->
                    <form action="{{route('admin.addfaculty')}}" method="POST" id="new_faculty_form">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <!-- content goes here -->
                    <form action="{{route('admin.addCourse')}}" method="POST" id="add_course_form">
...
@push('footer-script')
    <script>
        $('#save-form').click(function () {
            $.easyAjax({
                url: '{{route('admin.supervisors.update', [$userDetail->id])}}',
...
//
        ...
        $('#add_course_form').on('submit', function (e) {
            e.preventDefault();
            var data=$(this).serialize();
            $.post("{{route('admin.addCourse')}}", data, function (data) {
                // console.log(data);
        ...
        $('#faculty_value').on('change', function (e) {
            ...
            $.get("{{route('admin.getCourses')}}", {faculty_id:faculty_id}, function (data) {
                console.log(data);
