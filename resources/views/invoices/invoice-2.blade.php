        ...
        <section id="items">
            ...
            <table cellpadding="0" cellspacing="0">
                ...
                <tr data-iterate="item">
                    ...
                    <td>{{ $item->quantity }}</td>
                    <td>{!! htmlentities($invoice->currency->currency_symbol)  !!}{{ $item->unit_price }}</td>
                    <td>{!! htmlentities($invoice->currency->currency_symbol)  !!}{{ $item->amount }}</td>
                </tr>
                    @endif
                @endforeach
        ...
        <section id="sums">
            ...
            <table cellpadding="0" cellspacing="0">
                <tr>
                    ...
                    <td>{!! htmlentities($invoice->currency->currency_symbol)  !!}{{ $invoice->sub_total }}</td>
                </tr>

                <tr data-iterate="tax">
                    <th>@lang("modules.invoices.discount"):</th>
                    <td>-{!! htmlentities($invoice->currency->currency_symbol)  !!}{{ $discount }}</td>
                </tr>

                @foreach($taxes as $tax)
                <tr data-iterate="tax">
                    <th>{{ strtoupper($tax->item_name) }}:</th>
                    <td>{!! htmlentities($invoice->currency->currency_symbol)  !!}{{ $tax->amount }}</td>
                </tr>
                @endforeach
                ...
                <tr class="amount-total">
                    ...
                    <td>
                        <hr>{!! htmlentities($invoice->currency->currency_symbol)  !!}{{ $invoice->total }}</td>
                </tr>
