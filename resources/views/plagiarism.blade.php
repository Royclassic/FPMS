...
try{
    ...
    $additionalHeaders = array($clConst['SANDBOX_MODE_HEADER'], // Sandbox mode - Scan without consuming any credits and get back dummy results
       // $clConst['HTTP_CALLBACK'].': http://workmate.kawindierrands.com/copyleaks/callback' ,# For a fast testing of callbacks option we recommend to use http://requestb.in
        // $clConst['AUTHORIZATION_HEADER']. '',
    ...
    $process = $clCloud->createByFile(public_path('chapterThree.pdf'), $additionalHeaders);
