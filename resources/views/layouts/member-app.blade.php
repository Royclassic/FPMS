...
<head>
    ...
    <title>Supervisor Panel | {{ $pageTitle }}</title>
    <!-- Bootstrap Core CSS -->
    ...
    <!-- We have chosen the skin-blue (default.css) for this starter
       ...
       -->
    <link href="{{asset('plugins/moment/min/moment.min.js') }}" rel="stylesheet">
    ...
    {{--<link href="{{ asset('plugins/bower_components/bootstrap-daterangepicker/daterangepicker.js') }}" rel="stylesheet">--}}
        ...
        <nav class="navbar navbar-default navbar-static-top m-b-0">
            <div class="navbar-header">
                ...
                <div class="top-left-part">
                    <!-- Logo -->
                    <a class="logo hidden-xs hidden-sm" href="{{ route('supervisor.dashboard') }}">
                        <!-- Logo icon image, you can use font-icon also -->
                        @if(is_null($global->logo))
                            <!--This is dark logo icon-->
                            <img src="{{ asset('supervisor.png') }}" alt="home"
                                 class="dark-logo member-logo"/>
                        @else
                            <img src="{{ asset('storage/app-logo/'.$global->logo) }}" alt="home" class="dark-logo"/>
                        @endif
                    </a>
...
@endif
    ...
    <script src="{{URL::to('plugins/moment/min/moment.min.js')}}"></script>
    ...
    <script>
        ...
        function addOrEditStickyNote(id) {
            ...
            if (id === undefined || id == "" || id == null) {
                url = '{{ route('supervisor.sticky-note.store') }}'
            } else {

                url = "{{ route('supervisor.sticky-note.update',':id') }}";
        ...
        function showCreateNoteModal() {
            var url = '{{ route('supervisor.sticky-note.create') }}';
        ...
        function showEditNoteModal(id) {
            var url = '{{ route('supervisor.sticky-note.edit',':id') }}';
            url = url.replace(':id', id);
        ...
        function deleteSticky(id) {
            ...
            swal({
                ...
                if (isConfirm) {
                    ...
                    var url = "{{ route('supervisor.sticky-note.destroy',':id') }}";
                    url = url.replace(':id', id);
        ...
        function getNoteData() {
            ...
            var url = "{{ route('supervisor.sticky-note.index') }}";
