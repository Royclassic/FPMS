...
<head>
    ...
    <title>Coordinator Panel | {{ $pageTitle }}</title>
    <!-- Bootstrap Core CSS -->
    ...
    <nav class="navbar navbar-default navbar-static-top m-b-0">
        <div class="navbar-header">
            ...
            <div class="top-left-part">
                <!-- Logo -->
                <a class="logo hidden-xs hidden-sm" href="{{ route('admin.dashboard') }}">
                    @if(is_null($global->logo))
                            <!--This is dark logo icon-->
                    <img src="{{ asset('coordinator.png') }}" alt="home" class="dark-logo admin-logo"/>
                    @else
            ...
            <ul class="nav navbar-top-links navbar-right pull-right">
                <li><a href="{{ route('admin.user-chat.index') }}" class="waves-effect"><i class="icon-envelope"></i> <span
                                class="hide-menu"> @if($unreadMessageCount > 0)<span
...
<!-- <div id="footer-sticky-notes" class="row">
    <div class="col-md-12" id="sticky-note-header">
        ...
        Sticky Notes <a href="javascript:;" onclick="showCreateNoteModal()" class="btn btn-success btn-outline btn-xs m-l-10"><i class="fa fa-plus"></i> @lang("modules.sticky.addNote")</a>
            </div>
        <div class="col-xs-2">
...
<script src="{{URL::to('plugins/input-mask/input-mask.min.js')}} "></script>
{{--sticky note script--}}
