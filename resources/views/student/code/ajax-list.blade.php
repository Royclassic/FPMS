    ...
    <li class="list-group-item">
        <div class="row">
            ...
            <div class="col-md-3">
                ...
                &nbsp;&nbsp;
                <a href="{{ route('student.files.download', $file->id) }}" data-toggle="tooltip" data-original-title="Download" class="btn btn-inverse btn-circle"><i class="fa fa-download"></i></a>
