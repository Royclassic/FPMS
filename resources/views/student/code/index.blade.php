...
@section('page-title')
    <div class="row bg-title">
        ...
        <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
            <h4 class="page-title"><i class="{{ $pageIcon }}"></i> Project Codes</h4>
        </div>
        <!-- /.page title -->
        <!-- .breadcrumb -->
            ...
            <section>
                <div class="sttabs tabs-style-line">
                    <div class="white-box">
                        <nav>
                            <ul>
                                <li><a href="{{route('student.files.overview')}}"><span>Overview</span></a>
                                </li>
                                <li class="tab-current"><a href="{{route('student.files.index')}}"><span>Codes</span></a> </li>
                                ...
                                <div class="col-md-12" id="files-list-panel">
                                    <div class="white-box">
                                        ...
                                        <div class="row m-b-20 hide" id="file-dropzone">
                                            <div class="col-md-12">
                                                <form action="{{ route('student.files.store') }}" class="dropzone"
                                            ...
                                            @forelse($proposal->files as $file)
                                                <li class="list-group-item">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-3">
                                                            <a target="_blank" href="{{ asset('storage/codes/'.$proposal->id.'/'.$file->hashname) }}"
                                                               data-toggle="tooltip" data-original-title="View"
                                                               class="btn btn-info btn-circle"><i
                                                                        class="fa fa-search"></i></a>
                                                            &nbsp;&nbsp;
                                                            <a href="{{ route('student.files.download', $file->id) }}"
        ...
        $('body').on('click', '.sa-params', function () {
            ...
            swal({
                ...
                if (isConfirm) {
                    ...
                    var url = "{{ route('student.files.destroy',':id') }}";
