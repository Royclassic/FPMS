                                ...
                                <div class="pm-body clearfix">
                                    <div class="pmb-block ">
                                        ...
                                        <div class="pmbb-body p-l-30">
                                            ...
                                            <form method="POST" action="{{route('student.updateBasic')}}">
                                                {{csrf_field()}}
                                                <div class="pmbb-edit">
                                                    <dl class="dl-horizontal">
                                    ...
                                    <div class="pmb-block">
                                        ...
                                        <div class="pmbb-body p-l-30">
                                            ...
                                            <form method="POST" action="{{route('student.updateContact')}}">
                                                {{csrf_field()}}
                                                <div class="pmbb-edit">
                                                    <dl class="dl-horizontal">
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                ...
                                <!-- content goes here -->
                                <form id="updateform" method="POST" action="{{route('student.updatephoto')}}" enctype="multipart/form-data">
                                    {{csrf_field()}}
