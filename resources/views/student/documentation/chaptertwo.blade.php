    ...
    @if($documentation->chapterTwo==null)
        <div class="row">
            <div class="col-md-12">
                <div class="white-box">
                    <div class="card">
                        <form class="form-horizontal" role="form" action="{{route('student.chapterTwo.save')}}" method="POST" enctype="multipart/form-data">
                            {{csrf_field()}}
                    ...
                    <div class="">
                        ...
                        <div class="t-view" data-tv-type="text">
                                        ...
                                        <div class="pmbb-body p-l-30">
                                            ...
                                            <div class="pmbb-view">
                                                <dl class="dl-horizontal">
                                                    <dt>Documentation</dt>
                                                    <dd>{{$documentation->chapterTwo->file}} &nbsp;&nbsp;&nbsp;&nbsp;
                                                        <a href="{{URL::to('documentations/'.$user->email.'/'.$documentation->chapterTwo->file)}}" target="_blank">
                                                ...
                                                <dl class="dl-horizontal">
                                                    <dt>Status</dt>
                                                    @if($documentation->chapterTwo->status==0)
                                                        <dd><button class="btn btn-warning btn-xs">Approval Pending</button></dd>
                                                    @elseif($documentation->chapterTwo->status==2)
                            ...
                            <div class="tv-comments">
                                <ul class="tvc-lists">
                                    @if($documentation->chapterTwo->comment!==null)
                                        <li class="media">
                                            <a href="" class="tvh-user pull-left">
                                            ...
                                            <div class="media-body">
                                                ...
                                                <small class="c-gray">{{$documentation->chapterTwo->updated_at->toDayDateTimeString()}}</small>

                                                <div class="m-t-10">{{$documentation->chapterTwo->comment}}
                                                </div>
                                                <div class="clearfix"></div>
                                                <ul class="tvb-stats">
                                                    @if($documentation->chapterTwo->completion==1)
                                                        <li class="tvbs-comments"> Fully Completed</li>
                                                    @elseif($documentation->chapterTwo->completion==2)
                                                        <li class="tvbs-likes">Partially Completed</li>
                                                    @elseif($documentation->chapterTwo->completion==3)
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <!-- content goes here -->
                        <form id="updateform" method="POST" action="{{route('student.chapterTwo.save')}}" enctype="multipart/form-data">
                            {{csrf_field()}}
                            <div class="form-group">
                                <label for="password" class="col-sm-12 control-label" style="text-align: left;">
