        ...
        @if($documentation==null)
            <div class="row">
                <div class="col-md-12">
                    <div class="white-box">
                        <div class="card">
                            <form class="form-horizontal" role="form" action="{{route('student.chapterOne.save')}}" method="POST" enctype="multipart/form-data">
                                {{csrf_field()}}
                        ...
                        <div class="">
                            ...
                            <div class="t-view" data-tv-type="text">
                                            ...
                                            <div class="pmbb-body p-l-30">
                                                ...
                                                <div class="pmbb-view">
                                                    <dl class="dl-horizontal">
                                                        <dt>Documentation</dt>
                                                        <dd>{{$documentation->chapterOne->file}} &nbsp;&nbsp;&nbsp;&nbsp;
                                                            <a href="{{URL::to('documentations/'.$user->email.'/'.$documentation->chapterOne->file)}}" target="_blank">
                                                    ...
                                                    <dl class="dl-horizontal">
                                                        <dt>Status</dt>
                                                        @if($documentation->chapterOne->status==0)
                                                            <dd><button class="btn btn-warning btn-xs">Approval Pending</button></dd>
                                                        @elseif($documentation->chapterOne->status==2)
                                ...
                                <div class="tv-comments">
                                    <ul class="tvc-lists">
                                        @if($documentation->chapterOne->comment!==null)
                                            <li class="media">
                                                <a href="" class="tvh-user pull-left">
                                                ...
                                                <div class="media-body">
                                                    ...
                                                    <small class="c-gray">{{$documentation->chapterOne->updated_at->toDayDateTimeString()}}</small>

                                                    <div class="m-t-10">{{$documentation->chapterOne->comment}}
                                                    </div>
                                                    <div class="clearfix"></div>
                                                    <ul class="tvb-stats">
                                                        @if($documentation->chapterOne->completion==1)
                                                            <li class="tvbs-comments"> Fully Completed</li>
                                                        @elseif($documentation->chapterOne->completion==2)
                                                            <li class="tvbs-likes">Partially Completed</li>
                                                        @elseif($documentation->chapterOne->completion==3)
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <!-- content goes here -->
                            <form id="updateform" method="POST" action="{{route('student.chapterOne.save')}}" enctype="multipart/form-data">
                                {{csrf_field()}}
                                <div class="form-group">
                                    <label for="password" class="col-sm-12 control-label" style="text-align: left;">
