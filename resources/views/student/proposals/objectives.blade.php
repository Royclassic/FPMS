...
@section('page-title')
    <div class="row bg-title">
        ...
        <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
            <h4 class="page-title"><i class="{{ $pageIcon }}"></i> Objectives</h4>
        </div>
        <!-- /.page title -->
        <!-- .breadcrumb -->
        <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
            <ol class="breadcrumb">
                ...
                <li><a href="{{ route('student.proposal.title') }}">Objectives</a></li>
            </ol>
        </div>
        <!-- /.breadcrumb -->
    </div>
        ...
        @if($objective==null)
            <div class="row">
                <div class="col-md-12">
                    <div class="white-box">
                        <div class="card">
                            <form class="form-horizontal" role="form" action="{{route('student.objectives.save')}}" method="POST">
                                {{csrf_field()}}
                    ...
                    <div class="white-box">
                        <div class="">
                            ...
                            <div class="t-view" data-tv-type="text">
                                ...
                                <div class="tv-comments">
                                    <ul class="tvc-lists">
                                        ...
                                        @endforelse
                                        <form action="{{route('student.objective.reply')}}" method="POST">
                                            {{csrf_field()}}
                                            <li class="p-20">
                                                <div class="fg-line">
                            ...
                            <div class=" row text-center" >
                                <button type="submit"
                                        class="btn btn-primary btn-sm" onclick="return titleEdit('{{$objective->id}}') ">Edit Objectives
                                </button>
                            </div>
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <!-- content goes here -->
                            <form id="updateform" method="POST" action="{{route('student.objective.update')}}">
                                {{csrf_field()}}
                                <!-- <div class="form-group">
    ...
    <script type="text/javascript">{
            ...
            function titleEdit(id) {
                swal({
                    ...
                    if (isConfirm) {
                        var submiturl="{{URL::to('student/proposal/objectives/edit')}}";
                        $.ajax({
                            url:submiturl+ '/' +id,
                            type:'GET',
                            data:'',
