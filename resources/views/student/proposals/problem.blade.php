                ...
                <div class="col-md-12">
                    <div class="white-box">
                        <div class="card">
                            ...
                            @endif
                            <form class="form-horizontal" role="form" action="{{route('student.problem.save')}}" method="POST">
                                {{csrf_field()}}
                                <div class="card-header">
                  ...
                  <div class="white-box">
                      <div class="">
                          ...
                          <div class="t-view" data-tv-type="text">
                              ...
                              <div class="tv-comments">
                                  <ul class="tvc-lists">
                                      ...
                                      @endforelse
                                      <form action="{{route('student.problem.reply')}}" method="POST">
                                          {{csrf_field()}}
                                          <li class="p-20">
                                              <div class="fg-line">
                          ...
                          <div class=" row text-center" >
                              <button type="submit"
                                      class="btn btn-primary  btn-sm" onclick="return problemEdit('{{$problem->id}}')">Edit Problem
                              </button>
                          </div>
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <!-- content goes here -->
                            <form id="updateform" method="POST" action="{{route('student.problem.update')}}">
                                {{csrf_field()}}
                                <div class="form-group">
