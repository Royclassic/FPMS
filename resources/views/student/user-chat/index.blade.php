...
<script>
    ...
    $('#submitBtn').on('click', function (e) {
        ...
        if (submitText == "" || submitText == undefined || submitText == null) {
            ...
            var url = "{{ route('student.user-chat.message-submit') }}";
    ...
    $("#userSearch").keyup(function (e) {
        var url = "{{ route('student.user-chat.user-search') }}";
    ...
    function getChatData(id, dpName, scroll) {
        ...
        var url = "{{ route('student.user-chat.index') }}";
    ...
    $('#new-chat').click(function () {
        var url = '{{ route('student.user-chat.create')}}';
