...
<?php $__env->startSection('page-title'); ?>
    <div class="row bg-title">
        ...
        <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
            <h4 class="page-title"><i class="<?php echo e($pageIcon); ?>"></i>  Proposal Upload</h4>
        </div>
        <!-- /.page title -->
        <!-- .breadcrumb -->
        <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
            <ol class="breadcrumb">
                ...
                <li><a href="<?php echo e(route('student.proposal.title')); ?>">Proposal Upload</a></li>
            </ol>
        </div>
        <!-- /.breadcrumb -->
    </div>
...
<?php $__env->startSection('content'); ?>
    ...
    <?php else: ?>
        <?php if($proposal->file==null): ?>
            <div class="row">
                <div class="col-md-12">
                    <div class="white-box">
                        <div class="card">
                            <form class="form-horizontal" role="form" action="<?php echo e(route('student.proposal.save')); ?>" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="t-view" data-tv-type="text">
                                ...
                                <div class="tv-comments">
                                    <ul class="tvc-lists">
                                        ...
                                        <?php endif; ?>
                                        <form action="<?php echo e(route('student.proposal.reply')); ?>" method="POST">
                                            <?php echo e(csrf_field()); ?>
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <!-- content goes here -->
                            <form id="updateform" method="POST" action="<?php echo e(route('student.proposal.update')); ?>" enctype="multipart/form-data">
                                <?php echo e(csrf_field()); ?>
