...
<?php $__env->startSection('page-title'); ?>
    <div class="row bg-title">
        ...
        <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
            <h4 class="page-title"><i class="icon-doc"></i> Project Codes</h4>
        </div>
        <!-- /.page title -->
        <!-- .breadcrumb -->
                ...
                <div class="table-responsive">
                    <table  class="table table-bordered table-hover toggle-circle default footable-loaded footable" id="example" width="100%">
                        ...
                        <?php $__currentLoopData = $students; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$student): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <?php if($student->proposal!==null && $student->proposal->files->count()!==0): ?>
                                <tr>
                                    ...
                                    <?php if($student->proposal->status==0): ?>
                                        <td><button class="btn btn-warning btn-xs">Pending</button></td>
                                    <?php elseif($student->proposal->status==2): ?>
                                        <td><button class="btn btn-danger btn-xs">Denied Approval</button></td>
                                    <?php else: ?>
                                        <td><button class="btn btn-success btn-xs">Approved</button></td>
                                    <?php endif; ?>
                                    <td>
                                        <a href="<?php echo e(route('supervisor.codes.find', $student->id)); ?>">
                                            <button type="button"  class="btn btn-success btn-xs " ><span class="zmdi zmdi-eye" ></span> View Files</button>
                                        </a>
                                    </td>
                                </tr>
                            <?php endif; ?>
