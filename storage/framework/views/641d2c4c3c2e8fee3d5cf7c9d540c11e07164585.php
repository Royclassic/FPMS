<div class="modal fade" id="editChapterTwoAssessment" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title">Edit Chapter Two assessment</h4>
            </div>
            <div class="modal-body">
                <!-- content goes here -->
                <form action="<?php echo e(route('supervisor.docs.chaptertwo.assessment')); ?>" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-12">
                            <div class="fg-line<?php echo e($errors->has('milestone') ? ' has-error' : ''); ?>">
                                <textarea class="form-control" name="comment" rows="5" id="sum" required></textarea>
                            </div>
                            <br><br>
                        </div>
                        <br><br>
