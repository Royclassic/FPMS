<div class="modal-header">
    ...
    <h4 class="modal-title"><?php if(isset($noteDetail->id)): ?> <?php echo app('translator')->getFromJson('app.edit'); ?> <?php else: ?> <?php echo app('translator')->getFromJson('app.addNew'); ?> <?php endif; ?> Sticky Note</h4>
</div>
<div class="modal-body">
    <div class="form-group">
        <label for="note-text" class="control-label">Note:</label>
