            ...
            <section>
                <div class="sttabs tabs-style-line">
                    <div class="white-box">
                        <nav>
                            <ul>
                                <li><a href="<?php echo e(route('student.files.overview')); ?>"><span>Overview</span></a>
                                </li>
                                <li class="tab-current"><a href="<?php echo e(route('student.files.index')); ?>"><span>Codes</span></a> </li>
                                        ...
                                        <div class="row m-b-10">
                                            <div class="col-md-12">
                                                <a href="javascript:;" id="show-dropzone"
                                                   class="btn btn-success btn-outline"><i class="ti-upload"></i> <?php echo app('translator')->getFromJson('modules.projects.uploadFile'); ?></a>
                                            </div>
                                        </div>

                                        <div class="row m-b-20 hide" id="file-dropzone">
                                            <div class="col-md-12">
                                                <form action="<?php echo e(route('student.files.store')); ?>" class="dropzone"
                                                      id="file-upload-dropzone">
                                                    <?php echo e(csrf_field()); ?>


                                                    <?php echo Form::hidden('proposal_id', $proposal->id); ?>
                                                ...
                                                <li class="list-group-item">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-3">
                                                            ...
                                                            &nbsp;&nbsp;
                                                            <a href="<?php echo e(route('student.files.download', $file->id)); ?>"
