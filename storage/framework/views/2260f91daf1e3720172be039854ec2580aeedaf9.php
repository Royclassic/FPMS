...
<head>
    ...
    <!-- color CSS -->
    <link href="<?php echo e(asset('css/colors/red-dark.css')); ?>" id="theme"  rel="stylesheet">
    ...
    <style>
        .login-register{
            background: url('storage/login-background.jpg') center center/cover no-repeat!important;
        }
    </style>
    <?php endif; ?>
...
<section id="wrapper" class="login-register">
    <div class="login-box login-sidebar">
        ...
        <a href="javascript:void(0)" class="text-center db" style="padding: 25px 0; background: #000000;"><img src="<?php echo e(asset('supervisor.png')); ?>" style="max-width: 240px" alt="Home" /></a>
        <?php else: ?>
            <a href="javascript:void(0)" class="text-center db" style="padding: 25px 0; background: #000000;"><img src="<?php echo e(asset('storage/app-logo/'.$setting->logo)); ?>" alt="home"  style="max-width: 240px" /></a>
