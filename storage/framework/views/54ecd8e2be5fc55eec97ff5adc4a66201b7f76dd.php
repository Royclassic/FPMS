                ...
                <div class="panel-wrapper collapse in" aria-expanded="true">
                    <div class="panel-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="faculty" id="faculty_value" required>
                                            ...
                                            <?php $__currentLoopData = $faculties; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $faculty): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option <?php if($userDetail->faculty_id==$faculty->id): ?> selected <?php endif; ?> value="<?php echo e($faculty->id); ?>"><?php echo e($faculty->faculty); ?></option>
                        ...
                        <div class="form-actions">
                            ...
                            <a href="<?php echo e(route('admin.supervisors.index')); ?>" class="btn btn-default"><?php echo app('translator')->getFromJson('app.back'); ?></a>
                        </div>
                        <?php echo Form::close(); ?>
...
<?php $__env->startPush('footer-script'); ?>
    <script>
        $('#save-form').click(function () {
            $.easyAjax({
                url: '<?php echo e(route('admin.supervisors.update', [$userDetail->id])); ?>',
