<div class="modal fade" id="assessChapterOne" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title">Assess Chapter One Documentation</h4>
            </div>
            <div class="modal-body">
                <!-- content goes here -->
                <form action="<?php echo e(route('supervisor.docs.chapterone.assessment')); ?>" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-12">
                            <div class="fg-line<?php echo e($errors->has('milestone') ? ' has-error' : ''); ?>">
                                <textarea class="form-control" name="comment" id="sum" required></textarea>
                            </div>
                            <br><br>
                        </div>
                    </div>
