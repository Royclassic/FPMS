            ...
            <div class="white-box">
                <div class="row">
                    ...
                    <div class="col-sm-6 text-right">
                        <div class="form-group">
                            <a href="<?php echo e(route('admin.students.export')); ?>" class="btn btn-info btn-sm"><i class="ti-export" aria-hidden="true"></i> <?php echo app('translator')->getFromJson('app.exportExcel'); ?></a>
                        </div>
                    </div>
                </div>
