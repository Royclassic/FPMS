...
<?php $__env->startSection('content'); ?>
    <?php if($documentation->final_documentation==null): ?>
        <div class="row">
            <div class="col-md-12">
                <div class="white-box">
                    <div class="card">
                        <form class="form-horizontal" role="form" action="<?php echo e(route('student.final.save')); ?>" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="card-body card-padding">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-12">
                                        <div class="fg-line<?php echo e($errors->has('final_documentation') ? ' has-error' : ''); ?>">
                                            <input type="file" class="form-control" name="final_documentation"   required>
                                            <?php if($errors->has('final_documentation')): ?>
                                                <span class="help-block">
                                            <strong style="color: #dc3545;"><?php echo e($errors->first('final_documentation')); ?></strong>
                                        </span>
                                            <?php endif; ?>
                                        </div>
                                    </div>
                    ...
                    <div class="">
                        ...
                        <div class="t-view" data-tv-type="text">
                                        ...
                                        <div class="pmbb-body p-l-30">
                                            ...
                                            <div class="pmbb-view">
                                                <dl class="dl-horizontal">
                                                    <dt>Documentation</dt>
                                                    <dd><?php echo e($documentation->final_documentation); ?> &nbsp;&nbsp;&nbsp;&nbsp;
                                                        <a href="<?php echo e(URL::to('documentations/'.$user->email.'/'.$documentation->final_documentation)); ?>" target="_blank">
                            ...
                            <div class="tv-comments">
                                <ul class="tvc-lists">
                                    <?php if($documentation->comment!==null): ?>
                                        <li class="media">
                                            <a href="" class="tvh-user pull-left">
                                            ...
                                            <div class="media-body">
                                                ...
                                                <small class="c-gray"><?php echo e($documentation->updated_at->toDayDateTimeString()); ?></small>

                                                <div class="m-t-10"><?php echo e($documentation->comment); ?>

                                                </div>
                                                <div class="clearfix"></div>
                                                <ul class="tvb-stats">
                                                    <?php if($documentation->completion==1): ?>
                                                        <li class="tvbs-comments"> Fully Completed</li>
                                                    <?php elseif($documentation->completion==2): ?>
                                                        <li class="tvbs-likes">Partially Completed</li>
                                                    <?php elseif($documentation->completion==3): ?>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <!-- content goes here -->
                        <form id="updateform" method="POST" action="<?php echo e(route('student.final.save')); ?>" enctype="multipart/form-data">
                            <?php echo e(csrf_field()); ?>
