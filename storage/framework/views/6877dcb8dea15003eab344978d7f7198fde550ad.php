...
<head>
    ...
    <title>Supervisor Panel | <?php echo e($pageTitle); ?></title>
    <!-- Bootstrap Core CSS -->
    ...
    <!-- We have chosen the skin-blue (default.css) for this starter
       ...
       -->
    <link href="<?php echo e(asset('plugins/moment/min/moment.min.js')); ?>" rel="stylesheet">
    <link href="<?php echo e(asset('css/colors/gray-dark.css')); ?>" id="theme" rel="stylesheet">
    ...
    <style>
        ...
        #side-menu li a {
            color: <?php echo e($employeeTheme->sidebar_text_color); ?>;
            border-left: 0px solid<?php echo e($employeeTheme->sidebar_color); ?>;
        }
        ...
        #side-menu > li > a.active {
            border-left: 3px solid<?php echo e($employeeTheme->header_color); ?>;
            color: <?php echo e($employeeTheme->link_color); ?>;
        }
...
<?php if(Auth::check() && Auth::user()->passrec==0): ?>
        <?php
        $url = url('supervisor/profile/updatepassword');
        echo "<br><br><br>";
...
<?php else: ?>
    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-default navbar-static-top m-b-0">
            <div class="navbar-header">
                ...
                <div class="top-left-part">
                    <!-- Logo -->
                    <a class="logo hidden-xs hidden-sm" href="<?php echo e(route('supervisor.dashboard')); ?>">
                        <!-- Logo icon image, you can use font-icon also -->
                        <?php if(is_null($global->logo)): ?>
                            <!--This is dark logo icon-->
                            <img src="<?php echo e(asset('supervisor.png')); ?>" alt="home"
                                 class="dark-logo member-logo"/>
                        <?php else: ?>
                            <img src="<?php echo e(asset('storage/app-logo/'.$global->logo)); ?>" alt="home" class="dark-logo"/>
                        <?php endif; ?>
                    </a>

                    <div class="member-panel-name hidden-xs">Supervisor Panel</div>
                    ...
                    <?php if($user->hasRole('admin')): ?>
                        <li>
                            <a href="<?php echo e(route('admin.dashboard')); ?>">
                                <?php echo app('translator')->getFromJson('app.loginAsAdmin'); ?> <i class="ti-arrow-right"></i>
                            </a>
                        </li>
                    <?php endif; ?>
                ...
                <ul class="nav navbar-top-links navbar-right pull-right">
                    ...
                    <li class="dropdown" id="top-notification-dropdown">
                        ...
                        <ul class="dropdown-menu mailbox animated slideInDown">
                            ...
                            <?php if(count($user->unreadNotifications) > 0): ?>
                                <li>
                                    <a class="text-center" id="mark-notification-read" href="javascript:;"> Mark as read
        ...
        <!-- End Top Navigation -->
        <!-- Left navbar-header -->
        <?php echo $__env->make('sections.member_left_sidebar', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
...
<?php endif; ?>
    ...
    <script src="<?php echo e(URL::to('plugins/moment/min/moment.min.js')); ?>"></script>
    ...
    <script>
        ...
        function addOrEditStickyNote(id) {
            ...
            if (id === undefined || id == "" || id == null) {
                url = '<?php echo e(route('supervisor.sticky-note.store')); ?>'
            } else {

                url = "<?php echo e(route('supervisor.sticky-note.update',':id')); ?>";
        ...
        function showCreateNoteModal() {
            var url = '<?php echo e(route('supervisor.sticky-note.create')); ?>';
        ...
        function showEditNoteModal(id) {
            var url = '<?php echo e(route('supervisor.sticky-note.edit',':id')); ?>';
            url = url.replace(':id', id);
        ...
        function deleteSticky(id) {
            ...
            swal({
                ...
                if (isConfirm) {
                    ...
                    var url = "<?php echo e(route('supervisor.sticky-note.destroy',':id')); ?>";
                    url = url.replace(':id', id);
        ...
        function getNoteData() {
            ...
            var url = "<?php echo e(route('supervisor.sticky-note.index')); ?>";
