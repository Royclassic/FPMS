                ...
                <div class="col-md-12">
                    <div class="white-box">
                        <div class="card">
                            ...
                            <?php endif; ?>
                            <form class="form-horizontal" role="form" action="<?php echo e(route('student.problem.save')); ?>" method="POST">
                                ...
                                <div class="card-body card-padding">
                                    ...
                                    <div class="form-group">
                                        <label for="password" class="col-sm-12 control-label" style="text-align: left;">
                                            <b>Narrate the research problem associated with your chosen subarea of most interest to you? Between 250 - 500 words</b>
                                        </label>
                                        <div class="col-sm-12">
                                            <div class="fg-line<?php echo e($errors->has('password') ? ' has-error' : ''); ?>">
                                                <textarea class="form-control html-editor" name="problem" id="editor"  required></textarea>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group">
                  ...
                  <div class="white-box">
                      <div class="">
                          ...
                          <div class="t-view" data-tv-type="text">
                              ...
                              <div class="tv-comments">
                                  <ul class="tvc-lists">
                                      ...
                                      <?php endif; ?>
                                      <form action="<?php echo e(route('student.problem.reply')); ?>" method="POST">
                                          <?php echo e(csrf_field()); ?>
                          ...
                          <div class=" row text-center" >
                              <button type="submit"
                                      class="btn btn-primary  btn-sm" onclick="return problemEdit('<?php echo e($problem->id); ?>')">Edit Problem
                              </button>
                          </div>
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <!-- content goes here -->
                            <form id="updateform" method="POST" action="<?php echo e(route('student.problem.update')); ?>">
                                <?php echo e(csrf_field()); ?>

                                <div class="form-group">
                                    <label for="subarea" class="col-sm-12 control-label" style="text-align: left;">
                                        <b>Narrate the research problem associated with your chosen subarea of most interest to you? Between 250 - 500 words</b></label>
                                    <div class="col-sm-12">
                                        <div class="fg-line">
