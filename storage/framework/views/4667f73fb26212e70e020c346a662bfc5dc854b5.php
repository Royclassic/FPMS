...
<?php $__env->startSection('page-title'); ?>
    <div class="row bg-title">
        ...
        <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
            <h4 class="page-title"><i class="icon-doc"></i> Proposals</h4>
        </div>
        <!-- /.page title -->
        <!-- .breadcrumb -->
                    ...
                    <table  class="table table-bordered table-hover toggle-circle default footable-loaded footable" id="example" width="100%">
                        ...
                        <?php $__currentLoopData = $students; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$student): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <?php if($student->proposal==!null): ?>
                                <?php if($student->proposal->file==!null): ?>
                                    <tr>
                                        ...
                                        <td><?php echo e($student->proposal->file); ?></td>
                                        ...
                                        <?php endif; ?>
                                        <td>
                                            <a href="<?php echo e(route('supervisor.proposal.view', $student->proposal->id)); ?>">
