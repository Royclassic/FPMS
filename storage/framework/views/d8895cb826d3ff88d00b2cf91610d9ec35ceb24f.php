    ...
    <div class="row bg-title">
        ...
        <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
            <ol class="breadcrumb">
                ...
                <li><a class="active">Chapter Three</a></li>
            </ol>
        </div>
        <!-- /.breadcrumb -->
    </div>
...
<?php $__env->startSection('content'); ?>
    <?php if($documentation->chapterThree==null): ?>
        <div class="row">
            <div class="col-md-12">
                <div class="white-box">
                    <div class="card">
                        <form class="form-horizontal" role="form" action="<?php echo e(route('student.chapterThree.save')); ?>" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="card-body card-padding">
                                ...
                                <div class="form-group">
                                    <label for="password" class="col-sm-12 control-label" style="text-align: left;">
                                        <b>Upload your Documentation Chapter three. Only as pdf file</b>
                                    </label>
                                    <div class="col-sm-12">
                    ...
                    <div class="">
                        ...
                        <div class="t-view" data-tv-type="text">
                                        ...
                                        <div class="pmbb-body p-l-30">
                                            ...
                                            <div class="pmbb-view">
                                                <dl class="dl-horizontal">
                                                    <dt>Documentation</dt>
                                                    <dd><?php echo e($documentation->chapterThree->file); ?> &nbsp;&nbsp;&nbsp;&nbsp;
                                                        <a href="<?php echo e(URL::to('documentations/'.$user->email.'/'.$documentation->chapterThree->file)); ?>" target="_blank">
                                                ...
                                                <dl class="dl-horizontal">
                                                    <dt>Status</dt>
                                                    <?php if($documentation->chapterThree->status==0): ?>
                                                        <dd><button class="btn btn-warning btn-xs">Approval Pending</button></dd>
                                                    <?php elseif($documentation->chapterThree->status==2): ?>
                            ...
                            <div class="tv-comments">
                                <ul class="tvc-lists">
                                    <?php if($documentation->chapterThree->comment!==null): ?>
                                        <li class="media">
                                            <a href="" class="tvh-user pull-left">
                                            ...
                                            <div class="media-body">
                                                ...
                                                <small class="c-gray"><?php echo e($documentation->chapterThree->updated_at->toDayDateTimeString()); ?></small>

                                                <div class="m-t-10"><?php echo e($documentation->chapterThree->comment); ?>

                                                </div>
                                                <div class="clearfix"></div>
                                                <ul class="tvb-stats">
                                                    <?php if($documentation->chapterThree->completion==1): ?>
                                                        <li class="tvbs-comments"> Fully Completed</li>
                                                    <?php elseif($documentation->chapterThree->completion==2): ?>
                                                        <li class="tvbs-likes">Partially Completed</li>
                                                    <?php elseif($documentation->chapterThree->completion==3): ?>
                                    ...
                                    <?php else: ?>
                                        <li class="media">
                                            <div class="media-body">
                                                <div class="m-t-10" style="color: #dd7b0b">Your Chapter Three Document has not been assessed at the moment</div>
                                            </div>
                                        </li>
                                    <?php endif; ?>
                                </ul>
                        ...
                        <div class=" row text-center" >
                            <button type="submit"
                                    class="btn btn-primary  btn-sm" onclick="return problemEdit()">Edit Chapter Three
                            </button>
                        </div>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h3 class="modal-title" id="lineModalLabel">Edit chapterThree</h3>
                    </div>
                    <div class="modal-body">

                        <!-- content goes here -->
                        <form id="updateform" method="POST" action="<?php echo e(route('student.chapterThree.save')); ?>" enctype="multipart/form-data">
                            <?php echo e(csrf_field()); ?>

                            <div class="form-group">
                                <label for="password" class="col-sm-12 control-label" style="text-align: left;">
                                    <b>Upload your Project Documentation chapterThree. Only as pdf file</b>
                                </label>
                                <div class="col-sm-12">
