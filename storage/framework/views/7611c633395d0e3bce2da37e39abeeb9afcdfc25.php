...
<head>
    ...
    <title>Coordinator Panel | <?php echo e($pageTitle); ?></title>
    <!-- Bootstrap Core CSS -->
    ...
    <style>
        ...
        #side-menu li a {
            color: <?php echo e($adminTheme->sidebar_text_color); ?>;
            border-left: 0px solid <?php echo e($adminTheme->sidebar_color); ?>;
        }
    ...
    <nav class="navbar navbar-default navbar-static-top m-b-0">
        <div class="navbar-header">
            ...
            <div class="top-left-part">
                <!-- Logo -->
                <a class="logo hidden-xs hidden-sm" href="<?php echo e(route('admin.dashboard')); ?>">
                    <?php if(is_null($global->logo)): ?>
                            <!--This is dark logo icon-->
                    <img src="<?php echo e(asset('coordinator.png')); ?>" alt="home" class="dark-logo admin-logo"/>
                    <?php else: ?>
                        <img src="<?php echo e(asset('storage/app-logo/'.$global->logo)); ?>" alt="home" class="dark-logo"/>
                    <?php endif; ?>
                </a>

                <div class="admin-panel-name hidden-xs">Coordinator Panel</div>
            </div>
            <!-- /Logo -->
            ...
            <ul class="nav navbar-top-links navbar-right pull-right">
                <li><a href="<?php echo e(route('admin.user-chat.index')); ?>" class="waves-effect"><i class="icon-envelope"></i> <span
                                class="hide-menu"> <?php if($unreadMessageCount > 0): ?><span
...
<!-- <div id="footer-sticky-notes" class="row">
    <div class="col-md-12" id="sticky-note-header">
        ...
        Sticky Notes <a href="javascript:;" onclick="showCreateNoteModal()" class="btn btn-success btn-outline btn-xs m-l-10"><i class="fa fa-plus"></i> <?php echo app('translator')->getFromJson("modules.sticky.addNote"); ?></a>
            </div>
        <div class="col-xs-2">
...
<script src="<?php echo e(URL::to('plugins/input-mask/input-mask.min.js')); ?> "></script>
