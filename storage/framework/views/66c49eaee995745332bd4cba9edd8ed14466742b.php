...
<head>
    ...
    <title>Student Panel | <?php echo e($pageTitle); ?></title>
    <!-- Bootstrap Core CSS -->
...
<!-- This is a Custom CSS -->
    ...
    <!-- We have chosen the skin-blue (default.css) for this starter
       ...
       -->
    <link href="<?php echo e(asset('css/colors/green-dark.css')); ?>" id="theme" rel="stylesheet">
    ...
    <style>
        ...
        #side-menu li a {
            color: <?php echo e($clientTheme->sidebar_text_color); ?>;
            border-left: 0px solid<?php echo e($clientTheme->sidebar_color); ?>;
        }
        ...
        #side-menu > li > a.active {
            border-left: 3px solid<?php echo e($clientTheme->header_color); ?>;
            color: <?php echo e($clientTheme->link_color); ?>;
        }
...
<?php if(Auth::check() && Auth::user()->passrec==0): ?>
    <?php
    echo "<br><br><br>";
    ...
    echo "<div>";
    $url= url('student/profile/updatepassword');
...
<div id="wrapper">
    ...
    <nav class="navbar navbar-default navbar-static-top m-b-0">
        <div class="navbar-header">
            ...
            <div class="top-left-part">
                <!-- Logo -->
                <a class="logo hidden-xs hidden-sm" href="<?php echo e(route('student.dashboard.index')); ?>">
                    <!-- Logo icon image, you can use font-icon also -->
                <?php if(is_null($global->logo)): ?>
                    <!--This is dark logo icon-->
                        <img src="<?php echo e(asset('student.png')); ?>" alt="home" class="dark-logo client-logo"/>
                    <?php else: ?>
                        <img src="<?php echo e(asset('storage/app-logo/'.$global->logo)); ?>" alt="home" class="dark-logo"/>
                <?php endif; ?>
                <!-- Logo text image you can use text also -->
                </a>

                <div class="client-panel-name hidden-xs">Student Panel</div>
            </div>
            <!-- /Logo -->
                    ...
                    <ul class="dropdown-menu mailbox animated slideInDown">
                        <li>
                            <div class="drop-title">You have <span
                                        id="top-notification-count"><?php echo e(count($user->unreadNotifications)); ?></span> new
                                notifications
                            </div>
                        </li>
                        <?php $__currentLoopData = $user->unreadNotifications; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $notification): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <?php echo $__env->make('notifications.client.'.snake_case(class_basename($notification->type)), array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>

                        <?php if(count($user->unreadNotifications) > 0): ?>
                            <li>
                                <a class="text-center" id="mark-notification-read" href="javascript:;"> Mark as read <i
    ...
    <!-- End Top Navigation -->
    <!-- Left navbar-header -->
<?php echo $__env->make('sections.client_left_sidebar', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
<!-- Left navbar-header end -->
    ...
    <div id="page-wrapper">
        ...
        <!-- /.container-fluid -->
        <footer class="footer text-center"> <?php echo e(\Carbon\Carbon::now()->year); ?> &copy; <?php echo e($companyName); ?> </footer>
    </div>
    <!-- /#page-wrapper -->
</div>
<!-- /#wrapper -->
    ...
    <!-- <div id="footer-sticky-notes" class="row">
        <div class="col-md-12" id="sticky-note-header">
            <div class="col-xs-10" style="line-height: 30px">
                Sticky Notes <a href="javascript:;" onclick="showCreateNoteModal()"
                                class="btn btn-success btn-outline btn-xs m-l-10"><i
                            class="fa fa-plus"></i> <?php echo app('translator')->getFromJson("modules.sticky.addNote"); ?></a>
            </div>
            <div class="col-xs-2">
...
<?php endif; ?>
                        ...
                        <div class="row font-12">
                            ...
                            <div class="col-xs-3">
                                <a href="javascript:;" onclick="showEditNoteModal(<?php echo e($note->id); ?>)"><i
                                            class="ti-pencil-alt text-white"></i></a>
                                <a href="javascript:;" class="m-l-5" onclick="deleteSticky(<?php echo e($note->id); ?>)"><i
...
<script src="<?php echo e(URL::to('bootstrap-select/dist/js/bootstrap-select.js')); ?>"></script>
<script>
    ...
    function addOrEditStickyNote(id) {
        ...
        if (id === undefined || id == "" || id == null) {
            url = '<?php echo e(route('student.sticky-note.store')); ?>'
        } else {

            url = "<?php echo e(route('student.sticky-note.update',':id')); ?>";
    ...
    function showCreateNoteModal() {
        var url = '<?php echo e(route('student.sticky-note.create')); ?>';
    ...
    function showEditNoteModal(id) {
        var url = '<?php echo e(route('student.sticky-note.edit',':id')); ?>';
        url = url.replace(':id', id);
    ...
    function deleteSticky(id) {
        ...
        swal({
            ...
            if (isConfirm) {
                ...
                var url = "<?php echo e(route('student.sticky-note.destroy',':id')); ?>";
                url = url.replace(':id', id);
    ...
    function getNoteData() {
        ...
        var url = "<?php echo e(route('student.sticky-note.index')); ?>";
