...
<?php $__env->startSection('page-title'); ?>
    <div class="row bg-title">
        ...
        <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
            <h4 class="page-title"><i class="<?php echo e($pageIcon); ?>"></i> Supervisor Reports</h4>
        </div>
        <!-- /.page title -->
        <!-- .breadcrumb -->
        <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
            <ol class="breadcrumb">
                ...
                <li class="active">Supervisor Reports</li>
            </ol>
        </div>
        <!-- /.breadcrumb -->
    </div>
    ...
    <div class="white-box">
        <div class="row m-b-10">
            ...
            <div class="col-md-4">
                ...
                <form method="POST" action="<?php echo e(route('admin.reports.supervisors.generate')); ?>">
                    <?php echo e(csrf_field()); ?>

                    <div class="form-group">
                        <div class="row">
                            <div class="col-md-12">
                                <select class="select2 selectpicker form-control" name="report">
                                    <option value="" selected >---------------Select--------------</option>
                                    <option value="all">All Supervisors</option>
                                    <option value="active">Active Supervisors</option>
                                    <option value="inactive">Inactive Supervisors</option>
                                    <option value="assignedStudents">Assigned Students</option>
                                </select>
                            </div>
                        </div>
                    </div>
