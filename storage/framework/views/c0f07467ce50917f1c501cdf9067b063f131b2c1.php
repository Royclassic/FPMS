        ...
        <div class="white-box">
            <div class="">
                <div class="t-view" data-tv-type="text">
                    ...
                    <div class="tv-comments">
                        <ul class="tvc-lists">
                            ...
                            <?php endif; ?>
                            <form action="<?php echo e(route('supervisor.objective.review', $objective->id)); ?>" method="POST">
                ...
                <div class=" row text-center" >
                    <?php if($objective->status==0): ?>
                        <a href="<?php echo e(route('supervisor.objective.approve', $objective->id)); ?>">
                            <button  class="btn btn-primary  btn-sm">Accept
                            </button>
                        </a>
                        <a href="<?php echo e(route('supervisor.objective.disapprove', $objective->id)); ?>">
                            <button  class="btn btn-warning  btn-sm">Reject
                            </button>
                        </a>
                    <?php elseif($objective->status==1): ?>
                        <a href="<?php echo e(route('supervisor.objective.disapprove', $objective->id)); ?>">
