            ...
            <div class="white-box" style="padding-left: 10px !important;">
                <div class="" style="padding-left: 5px!important; margin-left: 5px" >
                                ...
                                <div class="pmbb-body p-l-30">
                                    <div class="pmbb-view">
                                        <dl class="dl-horizontal">
                                            <dt>Name</dt>
                                            <dd>
                                                <?php echo e($student->student->supervisor->user->name); ?>
                                        ...
                                        <dl class="dl-horizontal">
                                            ...
                                            <dt>Email</dt>
                                            <dd>
                                                <?php echo e($student->student->supervisor->user->email); ?>
                                        ...
                                        <dl class="dl-horizontal">
                                            <dt>Phone</dt>
                                            <dd>
                                                <?php echo e($student->student->supervisor->user->phone); ?>
                                    ...
                                    <div class="pmbb-view">
                                        ...
                                        <?php if($proposal->remarks==null): ?>
                                            <dl class="dl-horizontal">
                                                <dt>Remarks</dt>
                                                <dd>
                                                    <form action="<?php echo e(route('proposal.remark', $proposal->id)); ?>" method="POST">
                    ...
                    <div class=" row text-center" >
                        ...
                        <a href="<?php echo e(route('admin.students.proposals')); ?>">
