                ...
                <div class="row">
                    <div class="col-sm-6">
                        <div class="form-group">
                            <a href="<?php echo e(route('admin.notices.create')); ?>" class="btn btn-outline btn-success btn-sm"><?php echo app('translator')->getFromJson('modules.notices.addNotice'); ?> <i class="fa fa-plus" aria-hidden="true"></i></a>
                        </div>
                    </div>
                </div>
                ...
                <div class="table-responsive">
                    <table class="table table-bordered table-hover toggle-circle default footable-loaded footable" id="notice-table">
                        ...
                        <tr>
                            ...
                            <th><?php echo app('translator')->getFromJson('modules.notices.notice'); ?></th>
...
<script>
    $(function() {
        var table = $('#notice-table').dataTable({
            ...
            processing: true,
            serverSide: true,
            ajax: '<?php echo route('admin.notices.data'); ?>',
            language: {
